...
from crosssection.cross_section_calculations import calculate_crosssection
from crosssection.cross_section import AtomFactory


def test_calculate_cross_section_neon():
...
def test_calculate_cross_section_custom():
    atom = Atom(8)
