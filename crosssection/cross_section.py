...
# 7TeV PROTONS IS EQUAL TO THE ONE OF 3.81GeV ELECTRONS. HENCE AN ADAPTED VERSION OF THE BINARY ENCOUNTER DIPOLE MODEL
# IS USED TO DETERMINE THE DIFFERENTIAL CROSS SECTION, self.w_max, WHOSE ANALYTICAL FORM CAN BE
...
class CrossSectionCalcBebvm(CrossSectionCalc):
    def __init__(self, T, atom=AtomFactory.get_neon()):
        ...
        array_elems = [np.log(elem) for elem in (self.beta_t / self.beta_b)]cycler           0.10.0 
